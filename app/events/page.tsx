...
const events = [
  {
    ...
    description: "Help maintain our community garden by weeding, planting, and general cleanup activities.",
    type: "Environment",
    status: "open",
    spotsAvailable: 15,
  },
  {
    ...
    description: "Sort and organize food donations to help families in need.",
  ...
  },
  {
    ...
    description: "Engage with seniors through games, crafts, and conversation.",
    type: "Social",
    status: "open",
    spotsAvailable: 8,
  },
  {
    ...
    description: "Join us in cleaning up our beautiful coastline and protecting marine life.",
    type: "Environment",
    status: "open",
    spotsAvailable: 30,
  },
    ...
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="container mx-auto px-4">
        <div className="mb-8">
          ...
          <p className="text-gray-600">Discover meaningful ways to give back to your community</p>
        </div>
